...
return [
    ...
    */
    ...
    'billing_freemium_enabled' => (bool) env('SHOPIFY_BILLING_FREEMIUM_ENABLED'),
    ...
    */
    ...
    'webhooks' => [
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_UNINSTALLED', '')
        ],
        /*
            [
    ...
    */
    ...
    'scripttags' => [
        // [
        //     'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', env('APP_URL') . '/storeFront/proxy.js'),
